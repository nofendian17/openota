...
import (
	"errors"
	"github.com/nofendian17/openota/apigw/internal/delivery/rest/model/request/airline"
	"net/http"
...
func (h *handler) GetByID() http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		ctx := r.Context()
		ID := r.PathValue("airlineID")

		// Validate request
		if err := h.validator.Validate(&airline.GetByID{ID: ID}); err != nil {
